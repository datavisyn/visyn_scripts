...
function generate(items, base) {
  ...
  r.listNames = [].concat(r.listWebNames, new Separator(), r.listServerNames);
  r.listNamesWithDescription = [].concat(r.listWebNamesWithDescription, new Separator(), r.listServerNamesWithDescription);

  return r;
}

module.exports.plugin = generate([], types.plugin);
module.exports.lib = generate([], types.lib);
