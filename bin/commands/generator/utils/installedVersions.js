...
function warningMessage(versions) {
  return `\nWarnings: \n\n${chalk.yellow(
    `Your Node.js version ${versions.installed.node} (npm: ${versions.installed.npm}) is newer than the required Node.js version ${versions.required.node} (npm: ${versions.required.npm}).`,
